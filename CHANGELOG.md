...
* Fast Balanced Scheduling Mode.  
  ...
  To enable the fast balanced mode you need to run below powershell cmdlet: set-hpcclusterproperty -schedulingmode FastBalanced
